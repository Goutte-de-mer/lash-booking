...
function FieldLabel({ className, ...props }) {
  return (
    <Label
      ...
      className={cn(
        "group/field-label peer/field-label has-data-checked:border-primary not-has-data-checked:hover:border-primary/30 has-data-checked:bg-primary/5 flex w-fit gap-2 leading-snug transition group-data-[disabled=true]/field:opacity-50 has-[>[data-slot=field]]:rounded-2xl has-[>[data-slot=field]]:border-2 *:data-[slot=field]:p-4",
