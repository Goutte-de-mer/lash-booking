...
export default function Hero() {
  return (
    <section className="relative flex h-[90vh] items-center overflow-hidden">
      <div className="via-background absolute inset-0 bg-linear-to-br from-[#f6f2ee] to-[#f6f2ee]/50" />
      <div className="bg-primary/5 absolute top-20 right-10 h-72 w-72 rounded-full blur-3xl" />
      <div className="bg-accent/10 absolute bottom-20 left-10 h-96 w-96 rounded-full blur-3xl" />
      <div className="relative mx-auto grid h-full w-full max-w-7xl items-center gap-16 px-6 py-10 lg:grid-cols-2">
